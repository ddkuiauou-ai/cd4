  ...
  return (
    <Card>
      <CardHeader className="px-7">
        <CardTitle>LP1-1 연간 주가수익비율</CardTitle>
        <CardDescription>LP1-2 연말 기준 주가수익비율 리스트</CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>
                <div className="hidden sm:inline-block">LP2-1 날짜</div>
                <div className="sm:hidden">LP2-1 연도</div>
              </TableHead>
              <TableHead className="text-center">LP2-2 등락율</TableHead>
              <TableHead className="text-center">LP2-3 주가수익비율</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {valueWithRate.map(({ date, value, changeRate }) => (
              ...
              >
                ...
                <TableCell className="text-right">
                  {value === 0 ? (
                    <div className="font-medium ">적자</div>
                  ) : (
