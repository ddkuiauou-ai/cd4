...
import { PBRData, PeriodType } from "@/lib/pbr-utils";
import ChartPBREnhanced from "@/components/chart-PBR-enhanced";
import { EDGE_TO_EDGE_CARD_BASE } from "@/components/marketcap/layout";

interface PBRChartWithPeriodSwitcherProps {
    initialData: PBRData[];
}

export default function PBRChartWithPeriodSwitcher({ initialData }: PBRChartWithPeriodSwitcherProps) {
