...
interface DIVChartWithPeriodSwitcherProps {
    initialData: Array<{
        date: string;
        value: number;
        uniqueKey: string;
...
type PeriodType = '1M' | '1Y';

export default function DIVChartWithPeriodSwitcher({ initialData }: DIVChartWithPeriodSwitcherProps) {
