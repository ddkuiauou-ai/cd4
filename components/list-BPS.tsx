  ...
  return (
    <Card>
      <CardHeader className="px-7">
        <CardTitle>연간 주당순자산가치</CardTitle>
        <CardDescription>연말 기준 주당순자산가치 리스트</CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
            ...
            {valueWithRate.map(({ date, value, changeRate }) => (
              ...
              >
                ...
                <TableCell className="text-right">
                  <div className="font-medium ">{value.toLocaleString()}원</div>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
