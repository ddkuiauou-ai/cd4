...
export default async function SecurityDPSPage({ params }: SecurityDPSPageProps) {
  ...
  const headerDetail = {
    label: "DPS",
    value: periodAnalysis?.latestDPS ? `${periodAnalysis.latestDPS.toFixed(2)}원` : "—",
    badge: securityType,
  } as const;
            ...
            <div className="grid grid-cols-[auto_1fr] items-start gap-x-3 gap-y-1">
              ...
              <div data-slot="alert-description" className="space-y-2 text-sm leading-relaxed text-muted-foreground">
                ...
                <p className="text-xs text-muted-foreground/70 mt-2">
                  자세한 내용은 <a href="https://www.investopedia.com/terms/d/dividendper-share.asp" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline">Investopedia DPS 설명</a>을 참고하세요.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <header className="flex flex-wrap items-center gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 md:text-base">DPS 순위와 기본 정보를 확인합니다</p>
              </div>
            </header>
              ...
              <div className={`${EDGE_TO_EDGE_CARD_BASE} grid gap-4 sm:grid-cols-2 lg:grid-cols-3`}>
                ...
                <dl className="space-y-2 border-t border-border/60 p-4 sm:border-t-0 sm:border-l">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <dd className="font-medium text-right">{periodAnalysis?.latestDPS ? `${periodAnalysis.latestDPS.toFixed(2)}원` : "—"}</dd>
                  </div>
                  <div className="flex items-center justify-between text-sm">
          ...
          >
            <header className="flex flex-wrap items-center gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 md:text-base">{displayName}의 DPS 변동 패턴과 분포를 다양한 차트로 분석합니다</p>
              </div>
            </header>
                    ...
                    {heatmapData && heatmapData.length > 0 ? (
                      ...
                      <div className="flex flex-col items-center justify-center p-4 sm:p-8 space-y-2 sm:space-y-4 text-center">
                        ...
                        <div className="space-y-1 sm:space-y-2">
                          <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100">DPS 히트맵 데이터 없음</p>
                  ...
                  <div className="min-h-[200px] sm:min-h-[260px] flex-1">
                    ...
                    {result && result.length > 0 ? (
                      ...
                      <div className="flex flex-col items-center justify-center p-4 sm:p-8 space-y-2 sm:space-y-4 text-center">
                        ...
                        <div className="space-y-1 sm:space-y-2">
                          <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100">DPS 분포 데이터 없음</p>
            ...
            >
              <header className="flex flex-wrap items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 md:text-base">해당 기업 내 다른 종목과 DPS을 비교합니다</p>
                </div>
              </header>
            ...
            <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 md:text-base">DPS 차트와 연말 기준 상세 데이터를 확인합니다</p>
                </div>
              </div>
