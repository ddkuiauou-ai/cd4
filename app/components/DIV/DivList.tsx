    ...
    return (
        <Card>
            <CardHeader className="px-7">
                <CardTitle>연간 배당금수익율</CardTitle>
                <CardDescription>연말 기준 배당금수익율 리스트</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-center">배당금수익율</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
