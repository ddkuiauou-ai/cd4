    ...
    return (
        <Card>
            <CardHeader className="px-7">
                <CardTitle>연간 주가수익비율</CardTitle>
                <CardDescription>연말 기준 주가수익비율 리스트</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-center">주가수익비율</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
